                    ...
                    <div class="modal-dialog">
                        <div class="modal-content" style="background-color:#beeae2;">
                            <div class="modal-header">
                                <p class="fw-bold name">Confirm Logout</p> 
                            </div>
    ...
    ?>
        <div class="row d-flex align-item-center justify-content-center m-5 cursor-pointer">
            <div class="col-7 board ">
                <div class="row cardbg d-flex justify-content-center align-items-center container-fixed-height rounded-3 shadow-lg p-3">
                    <div class="col profilecard rounded h-100">
